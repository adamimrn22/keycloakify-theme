                    ...
                    <Fragment key={attribute.name}>
                        ...
                        >
                            <div className={kcClsx("kcLabelWrapperClass")}>
                                <label htmlFor={attribute.name} className="text-muted-foreground text-xs">
                                    {advancedMsg(attribute.displayName ?? "")}
                                </label>
                                {attribute.required && <span className="text-destructive"> *</span>}
                            </div>
                            <div className="text-muted-foreground placeholder:text-muted-foreground">
                                ...
                                {attribute.annotations.inputHelperTextAfter !== undefined && (
                                    <div className="text-destructive" id={`form-help-text-after-${attribute.name}`} aria-live="polite">
    ...
    return (
        <>
            <Input
                ...
                className={hasError ? "border-destructive focus-visible:ring-destructive" : "text-muted-foreground placeholder:text-muted-foreground"}
            ...
            {(() => {
                ...
                return (
                    <>
                        {/* We leave the FieldErrors and Multi-value buttons as they are */}
